...
# # Predict whether a new material can be used

# new_material_properties = [[440, 325, 207000, 79000, 0.3, 7860]]  # Example properties: [Su, Sy, E, G, mu, Ro]
# prediction = dtc.predict(new_material_properties)

# # Display the prediction
# x = prediction[0]
# print(f'The new material can be used: {x}')
